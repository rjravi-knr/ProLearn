  ...
  return (
    <PlView gradiant style={styles.container}>
      ...
      <PlCard style={styles.cardContainer}>
        <PlText style={styles.heading}>Forgot password</PlText>
        <PlText style={styles.subHeading}>Reset your password</PlText>
        ...
        style={styles.button}>Send resend Link</PlButton>
      </PlCard>
      <PlView style={styles.subView}>
        <TouchableOpacity
        onPress={() => navigation.navigate('SignIn')}
        >
          <PlText style={styles.loginHereText}>Back to Login</PlText>
        </TouchableOpacity>
      </PlView>
    </PlView>
  );
