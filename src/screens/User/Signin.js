  ...
  return (
    <PlView gradiant style={styles.container}>
      ...
      <PlCard style={styles.cardContainer}>
        <PlText style={styles.heading}>Welcome back</PlText>
        <PlText style={styles.subHeading}>Login to your account</PlText>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('ForgotPassword')}>
          <PlText style={styles.forgotPassword}>Forgot your password ?</PlText>
        </TouchableOpacity>
        <SocialMediaLogins />
      </PlCard>
      <PlView style={styles.subView}>
        <PlText style={styles.alreadyAccount}>Don't have an account ?</PlText>
        <TouchableOpacity onPress={() => navigation.navigate('SignUp')}>
          <PlText style={styles.loginHereText}>Register here</PlText>
        </TouchableOpacity>
      </PlView>
    </PlView>
  );
